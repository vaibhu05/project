...
<body>
	<div class="row">
		...
		<div class="form-group">
            ...
            <input type="number" name="otp" id="user_email">
			<p><label for="username">OTP</label></p>
        <input type="password" name="password" id="user_email">
			<p><label for="username">New password</label></p>
			<button onclick="showSpinner()" name="reset">Reset Password</button>
        </form>
		</div>
		<div class="footer">
